...
<body>
    ...
    <div class="contenedor-360">
        ...
        <div class="barra-navegacion">
            <a class="enlace-navegacion" href="/quienes_somos">
                <p class="texto-enlace">QUIENES SOMOS</p>
            </a>
            ...
            <a class="enlace-navegacion" href="/articulos">
                <p class="texto-enlace">EVENTOS Y ARTICULOS</p>
            </a>
            <a class="enlace-navegacion" href="/contactos">
                <p class="texto-enlace">CONTACTANOS</p>
            </a>
